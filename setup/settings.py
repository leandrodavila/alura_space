...
load_dotenv() #para carregar as vars de ambiente
...
SECRET_KEY = str(os.getenv('SECRET_KEY')) #pegou valor do .env
...
INSTALLED_APPS = [
    ...
    'apps.galeria.apps.GaleriaConfig', #galeria/apps.py
    'apps.usuarios.apps.UsuariosConfig', #usuarios/apps.py
]
...
# Media - diretorio para upload
MEDIA_ROOT= os.path.join(BASE_DIR, "media")

MEDIA_URL = "/media/"

STATIC_ROOT = os.path.join(BASE_DIR, 'static') #django vai criar
